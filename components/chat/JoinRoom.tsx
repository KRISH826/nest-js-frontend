...
import { Users, Loader2, Hash, MessageSquare, Search } from 'lucide-react'
import { useGetPublicChatRoomsQuery, useJoinChatRoomMutation } from '@/lib/api/chat-room/chatRoomApi'
...
export default function JoinRoom({ trigger, onSuccess }: JoinRoomProps) {
    ...
    } = useGetPublicChatRoomsQuery(undefined, {
        skip: !open // Will ONLY fetch when the dialog is open
    })
    const [joinChatRoom, { isLoading: isJoining, error, isError }] = useJoinChatRoomMutation()
