...
const LoginPage = () => {
    return (
        <div className="relative flex min-h-svh flex-col items-center justify-center gap-6 overflow-hidden bg-slate-50 p-6 md:p-10">
            ...
            <div className="absolute -top-24 -left-24 h-100 w-100 rounded-full bg-sky-300/50 blur-3xl" />
            <div className="absolute -bottom-24 -right-24 h-100 w-100 rounded-full bg-purple-300/50 blur-3xl" />
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-87.5 w-87.5 rounded-full bg-indigo-200/50 blur-3xl pointer-events-none" />
